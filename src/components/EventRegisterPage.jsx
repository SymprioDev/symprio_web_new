      ...
      <div className="bg-[#F7FAFD] min-h-screen pt-32 pb-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="mb-8 text-center">
            <p className="text-sm font-bold uppercase tracking-[0.24em] text-[#185ADB]">Events Registration</p>
            <h1 className="mt-4 text-4xl md:text-5xl font-semibold text-[#0A2D6E]">Register for an upcoming event</h1>
